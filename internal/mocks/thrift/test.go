...
type MockReq struct {
	...
	SomeInt int32             `thrift:"someInt,4" json:"someInt,omitempty"`
}
...
var MockReq_SomeInt_DEFAULT int32 = 1

func (p *MockReq) GetSomeInt() (v int32) {
	if !p.IsSetSomeInt() {
		return MockReq_SomeInt_DEFAULT
	}
	return p.SomeInt
}
...
func (p *MockReq) IsSetSomeInt() bool {
	return p.SomeInt != MockReq_SomeInt_DEFAULT
}
...
func (p *MockReq) ReadField4(iprot thrift.TProtocol) error {
...
func (p *MockReq) writeField4(oprot thrift.TProtocol) (err error) {
	if p.IsSetSomeInt() {
		if err = oprot.WriteFieldBegin("someInt", thrift.I32, 4); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteI32(p.SomeInt); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
