...
type kSecondServiceClient struct {
	*kClient
}

func (p *kSecondServiceClient) SecondtestString(ctx context.Context, thing string, callOptions ...callopt.Option) (r string, err error) {
