...
func NewFastThriftCodec(disableFastWrite, disableFastRead bool) remote.PayloadCodec {
	return &thriftCodec{
		disableFastWrite: disableFastWrite,
		disableFastRead:  disableFastRead,
	}
}
...
func (c thriftCodec) Marshal(ctx context.Context, message remote.Message, out remote.ByteBuffer) error {
	...
	// 2.2 encode thrift with normal way
